...
('cat_hair', 'HAIR', 'Hair styling, cutting, coloring services', '💇‍♀️', true),
('cat_makeup', 'MAKEUP', 'Professional makeup services', '💄', true),
('cat_nails', 'NAILS', 'Manicure, pedicure, nail art', '💅', true),
('cat_skincare', 'SKINCARE', 'Facial treatments, skincare services', '🧴', true),
('cat_massage', 'MASSAGE', 'Relaxation and therapeutic massage', '💆‍♀️', true)
ON CONFLICT (name) DO NOTHING;

-- Create admin user (password: admin123)
INSERT INTO users (id, email, password, first_name, last_name, role, status) VALUES
('admin_001', 'admin@homebonzenga.com', '$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj3bp.VpO/iG', 'System', 'Admin', 'ADMIN', 'ACTIVE')
